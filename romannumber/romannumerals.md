# DETECTION OF HANDWRITTEN ROMAN NUMERALS

### **Concept:**
 - To detect handwritten roman numerals 
 - Numerical values of these roman numerals are calculated
...
- Model used for this code can be downloaded from the following link: <br>
    https://gitlab.com/school-of-curious/reshma-ramesh-babu/blob/develope/romannumber/model_mnist6.h5
...
model = create_model()
model.load_weights('../model_mnist6.h5')
