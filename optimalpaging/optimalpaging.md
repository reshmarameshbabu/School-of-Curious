...
### **Concept:**
- A list of numbers is written and detected as a string for the optimal page replacement using CNN models.
- Page Replacement is performed using optimal algorithm. A list of pages is taken as input and they are allocated frames using optimal algorithm
- Optimal page replacement algorithm works as, to allocate memory to the page entering, the pages already allocated with frames are looked up and the one which isnt appearing again in the near future is replaced and its memory is allocated to this frame
...
- Model used for this code can be downloaded from the following link: <br>
    https://gitlab.com/school-of-curious/reshma-ramesh-babu/blob/develope/optimalpaging/model_mnist3.h5
...
- Memory is allocated using Optimal page replacement algorithm
- The new page entering is allocated the memory of the page which wont be used again in the near future. 
...
### **Operation:**
- Above code uses optimal page replacement algorithm, on pressing key 'p' every step occurs, i.e memory is allocated for every page entering
- On pressing key 'c', basic code for optimal page replacement algorithm is generated in a new frame. On running this code, basic algorithm implementation can be seen
...
### **Output Screenshots:**
![output1](optimal1.png)
![output2](optimal2.png)
![output3](optimal3.png)

### **Demo video link:**

https://www.dropbox.com/s/k3y1kwiv0muho61/optimalpaging.mp4?dl=0
